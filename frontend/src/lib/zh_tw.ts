...
const exactLeagueNames: Record<string, string> = {
  ...
  Allflame: '亡焰咒海',
  'Hardcore Allflame': '亡焰咒海（專家）',
  'Ruthless Allflame': '亡焰咒海. 殘暴',
  'HC Ruthless Allflame': '亡焰咒海. 殘暴（專家）',
  'SSF Allflame': '亡焰咒海「自力」',
  'HC SSF Allflame': '亡焰咒海（專家）「自力」',
  'SSF R Allflame': '亡焰咒海. 殘暴「自力」',
  'HC SSF R Allflame': '亡焰咒海. 殘暴（專家）「自力」',
  'Curse of the Allflame': '亡焰咒海',
  'Hardcore Curse of the Allflame': '亡焰咒海（專家）',
  'Solo Self-Found Curse of the Allflame': '亡焰咒海「自力」',
  'Hardcore Solo Self-Found Curse of the Allflame': '亡焰咒海（專家）「自力」',
  'SSF Curse of the Allflame': '亡焰咒海「自力」',
  'HC Curse of the Allflame': '亡焰咒海（專家）',
  'Ruthless Curse of the Allflame': '亡焰咒海. 殘暴',
  'Hardcore Ruthless Curse of the Allflame': '亡焰咒海. 殘暴（專家）',
  'HC Ruthless Curse of the Allflame': '亡焰咒海. 殘暴（專家）',
  Mirage: '遠古蜃景',
